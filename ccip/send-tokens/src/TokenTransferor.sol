...
contract TokenTransferor is OwnerIsCreator {
  ...
  function _buildCCIPMessage(
    ...
    return Client.EVM2AnyMessage({
      ...
      extraArgs: Client._argsToBytes(
        ...
        Best Practice: For simplicity, the values are hardcoded. It is advisable to use a more dynamic approach, where you set the extra arguments off-chain. This allows adaptation depending on the lanes, messages, and ensures compatibility with future CCIP upgrades. 
  ...
  * @dev This function has no function body, making it a default function for receiving Ether. It is automatically called when Ether is transferred to the contract without any data
